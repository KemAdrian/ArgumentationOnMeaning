...
/**
 * This script creates an argumentation between two {@link Agent_simple}. One of them does not know one of the other {@link Agent_simple}'s {@link Concept}.
 * The results are saved in different files at the root of the repository.
 * 
 * @author kemoadrian
 *
 */
public class DELETE_parametric_run {
	...
	public static void run(int test_set, double redundancy, double errorValue, int ex) throws Exception {
		...
		// Change
		String removedA = adam.Kc.removeConcept("r", 0);
		String removedB = boby.Kc.removeConcept("n", 0);
