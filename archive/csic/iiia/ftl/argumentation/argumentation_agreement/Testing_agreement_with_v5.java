...
public class Testing_agreement_with_v5 {
	...
	public static void main(String[] arg) throws Exception{
		...
		Agent_v5 nick = new Agent_v5("nick");
		...
		nick.learnFromHypothesis(hypothesis, training_set.cases, new LearningPackage(o, dm, training_set.description_path, training_set.solution_path, SetCast.cast((training_set.differentSolutions()))));
