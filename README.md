...
You can find below a short presentation of argumentationMeaning's different packages. More information about the this source folder is available in the [Javadoc](https://github.com/keminus/ArgumentationOnMeaning/tree/master/Javadoc/index.html).
